...
import os
import logging
from scripts.preprocess import load_data, scale_data
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_path", default="data/winequality.csv")
    parser.add_argument("--model_path", default="models/nb_model.pkl")
